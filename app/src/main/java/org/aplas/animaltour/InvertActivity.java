...
public class InvertActivity extends AppCompatActivity {
    ...
    ImageView insectPic, arachnidPic, molluscPic, crustaceanPic, mediaButton, finishButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insectPic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation(InvertActivity.this, insectPic, ViewCompat.getTransitionName(insectPic));
        ...
        arachnidPic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation(InvertActivity.this, arachnidPic, ViewCompat.getTransitionName(arachnidPic));
                startActivity(intent,options.toBundle());
            }
        });
        ...
        molluscPic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation(InvertActivity.this, molluscPic, ViewCompat.getTransitionName(molluscPic));
                startActivity(intent,options.toBundle());
            }
        });
        ...
        crustaceanPic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation(InvertActivity.this, crustaceanPic, ViewCompat.getTransitionName(crustaceanPic));
                startActivity(intent,options.toBundle());
            }
        });
